...
const Main = (props) => {
  ...
  const { fetchVideoUrl, Videodata } = useUser();
    ...
    <>
      <Container>
        ...
        <Content>
          ...
          {/* Ivde add akitund...videoData array ill collection ile ella doc nteyum
           videodata varum..currently ipo first item mathrem eduthitullu...apo user id vech
            oronnineyum ningak select akam */}
          <ReactPlayer
            width={"40%"}
            height={"40%"}
            url={Videodata[0]}
